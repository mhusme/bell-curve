...
\begin{axis}[every axis plot post/.append style={
  ...
  \addplot[draw=black, fill=black, fill opacity=0.5, draw opacity =0.5] {gauss(0.5,0.70)};
  \addplot[draw=black, fill=black, fill opacity=0.5, draw opacity =0.5] {gauss(0.65,0.70)};
\end{axis}
\end{tikzpicture}
\end{document}